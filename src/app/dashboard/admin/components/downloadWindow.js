...
const DownloadWindow = () => {
    return (
        <div className="download-window">
            ...
            <div className="message">Download all images in the collection<br/><span>containing a total of <span className="number">45</span> images</span></div>
            <div className="password-access">
                <input type="text" id="download-password" name="password" placeholder="Enter password to access"/>
                <div className="warn">
